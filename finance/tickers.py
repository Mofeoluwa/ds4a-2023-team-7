tickers = ['ABMD','ATVI','ADBE','AMD','AGNC','AKAM','ALXN','ALGN',
'ALKS','ALNY','GOOG','GOOGL','AABA','AMZN','DOX','UHAL','AMOV','AAL','AMGN','ADI','ANGI',
...
'VOO','SPY','FENY','XOP','META','BRK/A','BRK/B','V','TSM','XOM','UNH','JNJ','JPM','WMT',
'MA','CVX','PG','LLY','HD','BABA','NVO','BAC','KO','ABBV','PFE','PEP','COST','AZN','TM',
'MCD','NKE','NVS','ABT','WFC','VZ','BMY','MS','UPS','TTE','HSBC','T','SCHW','SAP','ANGEN'
]